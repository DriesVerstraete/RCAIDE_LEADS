...
def append_bus_conditions(bus,segment,network): 
    ...
    segment.state.unknowns_lower_bounds.network[network.tag].busses[bus.tag] = Conditions()
    segment.state.unknowns_upper_bounds.network[network.tag].busses[bus.tag] = Conditions()   
