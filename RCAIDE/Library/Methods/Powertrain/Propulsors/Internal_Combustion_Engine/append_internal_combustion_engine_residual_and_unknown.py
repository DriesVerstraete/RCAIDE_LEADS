...
def append_internal_combustion_engine_residual_and_unknown(propulsor, segment):
    ...
    -------
    None
        Results are stored in segment.state.unknowns.mission and segment.state.residuals.mission.network
    ...
    segment.state.unknowns.mission[propulsor.tag  + '_propeller_omega']             = ones_row(1) * float(propeller.cruise.design_angular_velocity)  
    segment.state.residuals.mission[ propulsor.tag + '_rotor_engine_torque']        = 0. * ones_row(1)
    segment.state.unknowns_upper_bounds.mission[propulsor.tag + '_propeller_omega'] =   np.inf* ones_row(1) 
    segment.state.unknowns_lower_bounds.mission[propulsor.tag + '_propeller_omega'] = - np.inf* ones_row(1)
