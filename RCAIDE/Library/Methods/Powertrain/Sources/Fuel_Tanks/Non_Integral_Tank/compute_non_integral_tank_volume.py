...
#def compute_bwb_aft_tank_volume(fuel_tank, wing):
    ...
    #r_out     = (maximum_circle_coordinates[:,0] -  fuel_tank.wall_clearance) / 2
    ...
    #fuel_tank.outer_diameter = maximum_circle_coordinates[max_volume_index,0]  -  fuel_tank.wall_clearance 
    #fuel_tank.outer_length   =  2*(l[max_volume_index])
    #fuel_tank.inner_diameter = maximum_circle_coordinates[max_volume_index,0]  -  fuel_tank.wall_clearance - 2 * fuel_tank.wall_thickness
