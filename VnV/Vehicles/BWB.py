...
def vehicle_setup():
    ...
    segment.twist                                  = -2*Units.degree
    segment.percent_span_location                  = 0.0  
    segment.root_chord_percent                     = 1.0 
    segment.dihedral_outboard                      = 0  *  Units.degrees 
    segment.has_aft_fuel_tank                      =  True 
    ...
    segment.percent_span_location                  = (1.32 / wing.spans.projected) 
    segment.twist                                  = 0.03413864016900908
    ...
    segment.taper                                  = 0.32260442862265637   
    segment.percent_span_location                  = (3.8/wing.spans.projected)  
    segment.twist                                  = 0.03269583465402711
    ...
    segment.taper                                  = 0.32260442862265637   
    segment.percent_span_location                  = (12.244/wing.spans.projected) 
    segment.twist                                  = 0.0277833145860804
    ...
    segment.taper                                  = 0.32260442862265637   
    segment.percent_span_location                  = (14.376/wing.spans.projected) 
    segment.twist                                  = 0.026542967264329767
    segment.root_chord_percent                     = 0.57
    segment.dihedral_outboard                      = 5 *  Units.degrees    
    segment.sweeps.quarter_chord                   = 25*Units.degrees
    segment.has_fuel_tank                          = True
    segment.fuel_tank.percent_chord_start_location = 0.1  
    segment.fuel_tank.percent_chord_end_location   = 0.55   
    airfoil                                        = RCAIDE.Library.Components.Airfoils.Airfoil()
    airfoil.coordinate_file                        = rel_path +  's1016.txt' 
    segment.append_airfoil(airfoil )
    wing.append_segment(segment)     
    ...
    segment.twist                                  = 0.023223846467875314
    segment.root_chord_percent                     = 0.216
    ...
    segment.twist                                  = 0.01609418758319834
    segment.root_chord_percent                     = 0.104
    segment.dihedral_outboard                      = 1 *  Units.degrees 
    segment.sweeps.quarter_chord                   = 30 * Units.degrees  
    ...
    segment.root_chord_percent                     = 0.0416
    segment.twist                                  = 0.00069813170079773
    ...
    segment.twist                                  = 0
    segment.root_chord_percent                     = 0.016
    ...
    turbofan1.design_thrust                        = 22666.* Units.N  
    ...
    turbofan1.origin                             = [[28, 0, 2.25]]  
    
    
    net.propulsors.append(turbofan1)
    
    #------------------------------------------------------------------------------------------------------------------------------------  
    # Propulsor: Propulsor 2 (Starboard Side)
    #------------------------------------------------------------------------------------------------------------------------------------       
    turbofan2                                  = deepcopy(turbofan1)
    turbofan2.active_fuel_tanks                = ['fuel_tank'] 
    turbofan2.tag                              = 'propulsor_2' 
    turbofan2.origin                           = [[27, 4.2, 2.25]] 
    turbofan2.nacelle.tag                      =  'propulsor_2_nacelle'
    turbofan2.nacelle.origin                   = [[27, 4.2, 2.25]] 
        
    # append propulsor to distribution line 
    net.propulsors.append(turbofan2)

    #------------------------------------------------------------------------------------------------------------------------------------  
    # Propulsor: Propulsor 3 (Port Side)
    #------------------------------------------------------------------------------------------------------------------------------------       
    turbofan3                                  = deepcopy(turbofan1)
    turbofan3.active_fuel_tanks                = ['fuel_tank'] 
    turbofan3.tag                              = 'propulsor_3' 
    turbofan3.origin                           = [[27, -4.2, 2.25]] 
    turbofan3.nacelle.tag                      =  'propulsor_3_nacelle'
    turbofan3.nacelle.origin                   = [[27, -4.2, 2.25]] 
    ...
    fuel_tank_4.aft_tank_start_root_chord              = 0.65
    fuel_tank_4.aft_tank_end_rood_chord                = 0.85
    fuel_tank_4.aft_tank_end_segment_tag               = 'fuel_wall' 
    fuel_tank_4.wing_root_tag                          = 'main_wing' 
    fuel_tank_4.wall_clearance                         = 0.05
    fuel_line.fuel_tanks.append(fuel_tank_4)

    #------------------------------------------------------------------------------------------------------------------------------------   
    # Assign propulsors to fuel line to network      
    fuel_line.assigned_propulsors =  [['propulsor_1', 'propulsor_2', 'propulsor_3']]
