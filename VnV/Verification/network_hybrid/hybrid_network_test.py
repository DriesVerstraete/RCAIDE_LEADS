...
def main():
    ...
    convetional_cruise_CL_truth      = 0.6870072518864385
    electric_cruise_CL_truth         = 0.6933519703620354
    series_hybrid_cruise_CL_truth    = 0.6917913826762634
    parallel_hybrid_cruise_CL_truth  = 0.6929884874812067
